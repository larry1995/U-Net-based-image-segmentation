...
def unet(pretrained_weights = None,input_size = (512,512, 1)):
    ...
    #norm1  = BatchNormalization(weights=None)(conv1)
    ...
    model.compile(optimizer = SGD(lr=0.01, decay=1e-6, momentum=0.9, nesterov=True),loss = 'binary_crossentropy', metrics = [dice_coef])
    #model.summary()
